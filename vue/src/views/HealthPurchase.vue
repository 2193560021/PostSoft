<template>
  ...
  <el-row class="row-bg" justify="center" gutter="20">
    <el-col :span="8">
      <el-image :src=purchaseLeft_img :fit="cover" style="height:400px"> </el-image>
      ...
      <div class="purchaseRight">
        ...
        >
          <el-descriptions-item>
            ...
            <el-tag size="large">{{ petName }}</el-tag>
     ...
     load(){
       this.petName = this.$route.query.name
         request.get("/health",{
           ...
           this.age = res.data.records[0].sale
           this.kind = res.data.records[0].kind
           this.liveStyle = res.data.records[0].note

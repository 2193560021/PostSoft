    ...
    <div style="margin:10px 0">
      ...
      >
        <el-form-item style="text-align: center" label-width="0">
          ...
          >
            <img :src="form.img" width="180" height="90" alt="img" class="avatar " style="border-radius: 10px">
          </el-upload>
        </el-form-item>
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="付款金额">
            <el-input v-model="form.price" style="width:80%;line-height: 18px"></el-input>
          </el-form-item>
          <el-form-item label="支付时间">
            <el-input v-model="form.payTime" disabled style="width:80%"></el-input>
          </el-form-item>
          <el-form-item label="买家ID">
            <el-input v-model="form.customerId" style="width:80%"></el-input>
          </el-form-item>
